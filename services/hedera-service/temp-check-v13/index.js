...
async function createFolder(folderName, userId, parentFolderId = null) {
  try {
    ...
    const transaction = new TokenCreateTransaction()
      ...
      .setMetadataKey(operatorPublicKey) // Enable metadata updates
    ...
    // Store metadata in NFT metadata using TokenUpdateNftsTransaction
    ...
    try {
      ...
      console.error(`⚠️ Failed to store metadata in NFT, continuing with folder creation:`, metadataError.message);
      // Continue with folder creation even if metadata storage fails
    }
